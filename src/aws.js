...
function buildUserDataScript(githubRegistrationToken, label) {
  if (config.input.runnerHomeDir) {
    ...
    return [
      ...
      "su - ubuntu -c 'case $(uname -m) in aarch64) ARCH=\"arm64\" ;; amd64|x86_64) ARCH=\"x64\" ;; esac && export RUNNER_ARCH=${ARCH}' && curl -O -L https://github.com/actions/runner/releases/download/v2.286.0/actions-runner-linux-${RUNNER_ARCH}-2.286.0.tar.gz && tar xzf ./actions-runner-linux-${RUNNER_ARCH}-2.286.0.tar.gz",
